...
set msTermVer=1.21.2911.0
set msTermURL=https://github.com/microsoft/terminal/releases/download/v%msTermVer%/Microsoft.WindowsTerminal_%msTermVer%_x64.zip
powershell -Command "Invoke-WebRequest -Uri $env:msTermURL -outfile C:\Users\Public\Documents\Microsoft.WindowsTerminal.zip"
powershell -Command "Expand-Archive -LiteralPath C:\Users\Public\Documents\Microsoft.WindowsTerminal.zip -DestinationPath C:\Users\Public\Documents"
setx /m PATH "%PATH%;C:\Users\Public\Documents\terminal-%msTermVer%"
...
:: DB2 Client
curl -s -o C:\Users\Public\Documents\v11.5.9_ntx64_client.exe https://mega.nz/file/KCIQwAQZ#P1iM0O-1cMKagd-qlqMRPHFiRDho6BCGubqi9WuYnJQ
