...
podman exec -it ROCKY dnf install terraform git python39 python3-pip ansible sshpass unzip -y
podman exec -it ROCKY python3 -m pip install install cryptography -U
podman exec -it ROCKY git clone https://github.com/UNiXMIT/UNiXIaC.git
